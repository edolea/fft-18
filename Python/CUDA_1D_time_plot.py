...
seq_input_dir = os.path.join(script_dir, "..", "OUTPUT_RESULT/sequential/1D")
cuda_input_dir = os.path.join(script_dir, "..", "OUTPUT_RESULT/CUDA/1D")
...
# Save
plot_path = os.path.join(plot_dir, "1D_fft_combined_with_speedup_loglog.pdf")
